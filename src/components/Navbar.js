    ...
    <nav className="bg-gray-700 p-4 sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          <form onSubmit={handleSearch} className={`${isSearchOpen ? 'flex' : 'hidden'} lg:flex items-center absolute lg:relative top-16 lg:top-0 left-0 right-0 bg-gray-900 lg:bg-transparent p-4 lg:p-0 z-30`}>
            <input
              type="text"
              placeholder="Movie Name..."
